...
estadual de Goiás — 50 títulos produzidos pelo **CriaLab UEG** para o **Goiás Tec**.
...
player do Bunny é o contrário. A garantia é dupla: parâmetros na URL do embed e o `allow` do
iframe sem `autoplay`. Os testes falham se qualquer uma das duas cair.
...
51 testes, sem rede e sem credenciais — cobrem as regras do produto, não a infraestrutura:
