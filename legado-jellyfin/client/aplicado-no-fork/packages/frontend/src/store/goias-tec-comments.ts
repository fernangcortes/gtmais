 ...
 * Padrão: DESLIGADO — o painel só aparece quando o usuário apertar C ou o botão de
 * comentário, para não cobrir o vídeo por padrão.
 */
export const commentsEnabled = ref(false);
