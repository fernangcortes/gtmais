  ...
  <section class="comments-section">
    <div class="comments-section__header">
      ...
      <div class="comments-section__filters">
        ...
        <VCheckbox
          v-model="commentFilter.includeResolved"
...
import {
  ...
  refreshPending,
  removeComment
} from '#/stores/goias-tec-comments.ts';
import { goiasTecApi } from '#/plugins/goiastec/goiastec-api.ts';
...
async function submit(): Promise<void> {
  ...
  try {
    ...
    useSnackbar().show('Falha ao comentar.');
  }
}
</script>
